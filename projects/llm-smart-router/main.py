...
def route_and_execute(prompt: str) -> str:
    ...
    if complexity == "LIGHT":
        print("[Router] Query is simple. Routing to fast, low-cost model (e.g., gpt-3.5-turbo).")
        target_model = "gpt-3.5-turbo"
    else:
        print("[Router] Query requires deep reasoning. Routing to heavy, capable model (e.g., gpt-4o).")
